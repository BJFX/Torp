...
namespace LOUV.Torp.LiveService
{
    public class NetLiveService_ACM : IMovNetCore
    {
        ...
        private static MonConfInfo _mocConf;
        ...
        public static IMovNetCore GetInstance(CommConfInfo conf, MonConfInfo movconf, Observer<CustomEventArgs> observer)
        {
            lock (SyncObject)
            {
                if (conf != null)
        ...
        protected NetLiveService_ACM(CommConfInfo conf, MonConfInfo movconf, Observer<CustomEventArgs> observer)
        {
            _commConf = conf;
            _mocConf = movconf;
        ...
        public static void RenewNetLiveService_ACM(CommConfInfo conf, MonConfInfo movconf)
        {
            _commConf = conf;
            _mocConf = movconf;
        }
