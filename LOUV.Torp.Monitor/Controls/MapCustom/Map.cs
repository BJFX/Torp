...
namespace LOUV.Torp.Monitor.Controls.MapCustom
{
    ...
    public class Map:GMapControl
    {
        ...
        private string PrintPosition(PointLatLng position)
        {
            return "(经度:" + position.Lng.ToString("F08") + ",纬度:" + position.Lat.ToString("F08")+")";
        }
        ...
        protected override void OnRender(DrawingContext drawingContext)
        {
            ...
            FormattedText centerpos = new FormattedText("中心:"+ PrintPosition(Position), CultureInfo.CurrentUICulture, fd, tf, 16, Brushes.WhiteSmoke);
            ...
            FormattedText mousepos = new FormattedText("鼠标:"+ PrintPosition(MousePosition), CultureInfo.CurrentUICulture, fd, tf, 16, Brushes.WhiteSmoke);
